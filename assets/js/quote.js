...
function resetValues() {
    // Input values
    DIV_NUMBER_OF_APARTMENT.querySelector('input').value = "";
    DIV_NUMBER_OF_FLOORS.querySelector("input").value = "";
    DIV_MAXIMUM_OCCUPANCY.querySelector("input").value = "";
    DIV_NUMBER_OF_ELEVATORS.querySelector("input").value = "";
    DIV_AMOUNT_ELEVATORS_NEEDED.querySelector("input").value = "";

    // Radio buttons
    document.getElementById("radio-button-standard").checked = false;
    document.getElementById("radio-button-premium").checked = false;
    document.getElementById("radio-button-excelium").checked = false;
}
...
document.getElementById("building-type").value="---Select---";
